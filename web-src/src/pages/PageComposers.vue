...
const composersData = {
  ...
  set: function (vm, response) {
    vm.composers = response.data.composers ? response.data.composers : response.data
  }
}
...
export default {
  ...
  components: { ContentWithHeading, TabsMusic, ListItemComposer, IndexList, ModalDialogComposer },
