          ...
          <div class="card">
            <div class="card-content">
              ...
              <div class="buttons" v-if="media_kind === 'podcast'">
                <a class="button is-small" v-if="new_tracks === undefined || new_tracks > 0" @click="mark_played">Mark as played</a>
                <a class="button is-small is-danger" @click="$emit('remove_podcast')">Remove podcast</a>
              </div>
