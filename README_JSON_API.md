...
| GET       | [/api/library/genre?name={genre}](#list-genre-albums)       | Get list of albums for a genre       |
...
| Key             | Type     | Value                                     |
| --------------- | -------- | ----------------------------------------- |
| items           | array    | Array of [`genre`](#album-object) objects |
...
```
GET /api/library/genre?name={genre}
```
...
| Key             | Type     | Value                                     |
| --------------- | -------- | ----------------------------------------- |
| genre           | string   | name of genre for album results           |
| items           | array    | Array of [`album`](#album-object) objects |
| total           | integer  | Total number of albums in the library     |
| offset          | integer  | Requested offset of the first albums      |
| limit           | integer  | Requested maximum number of albums        |
...
```
curl -X GET "http://localhost:3689/api/library/genre?name=Pop"
curl -X GET "http://localhost:3689/api/library/genre?name=Rock%2FPop"            # Rock/Pop
curl -X GET "http://localhost:3689/api/library/genre?name=Drum%20%26%20Bass"     # Drum & Bass
curl -X GET "http://localhost:3689/api/library/genre?name=%2790s%20Alternative"  # '90 Alternative
```
...
```
{
  ...
  "items": [
    ...
    },
    {
      ...
      "track_count": 1,
      "length_ms": 177926,
      "uri": "library:album:2025652208596637283"
    }
  ],
  "total": 2,
  "offset": 0,
