...
//    { HTTPD_METHOD_POST,   "^/api/library/playlists/[[:digit:]]+/tracks$", jsonapi_reply_library_playlists_tracks },
    ...
    { HTTPD_METHOD_GET,    "^/api/library/artists/[[:digit:]]+(,[[:digit:]]+)*$", jsonapi_reply_library_artist },
    { HTTPD_METHOD_GET,    "^/api/library/artists/[[:digit:]]+(,[[:digit:]]+)*/albums$", jsonapi_reply_library_artist_albums },
    { HTTPD_METHOD_GET,    "^/api/library/artists/[[:digit:]]+(,[[:digit:]]+)*/tracks$", jsonapi_reply_library_artist_tracks },
